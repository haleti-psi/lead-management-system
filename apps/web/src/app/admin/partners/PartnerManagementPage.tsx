...
type ModalState = { mode: 'create' } | { mode: 'edit'; partner: PartnerView } | null;
 ...
 * a modal form. Masked contact mobile, status chips, loading/error/empty states.
 */
export function PartnerManagementPage(): JSX.Element {
  ...
  const columns: DataTableColumn<PartnerView>[] = [
    ...
    { id: 'legalName', header: 'Legal Name', cell: (p) => p.legalName, sortable: true },
